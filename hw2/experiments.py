...
def cnn_experiment(
    ...
    **kw,
    ...
    channels = [k for k in filters_per_layer for l in range(layers_per_block)]
    model = model_cls(in_size, 10, channels, pool_every, hidden_dims, pooling_params=dict(kernel_size=2),\
